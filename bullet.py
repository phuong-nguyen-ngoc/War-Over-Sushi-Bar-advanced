...
class Bullet(pg.sprite.Sprite):
	...
	def __init__ (self, dir, posi, superbullet = False):
		...
		self.dir = dir
		if self.dir == 'up':
			self.rect.center=(posi[0],posi[1]-25)#self.rect.center=(posi[0]*40+120,posi[1]*40+220)
				
		elif self.dir == 'down':
			self.rect.center=(posi[0],posi[1]+25)

		elif self.dir == 'left':
			self.rect.center=(posi[0]-25,posi[1])
		...
		if superbullet:
			self.image= pg.image.load('special_bullet.png')
